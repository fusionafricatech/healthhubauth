...
function ClinicDashboard() {
    ...
    return (
        <div className="max-w-6xl mx-auto mt-10 px-4">
            <h2 className="text-3xl font-bold mb-4">Clinic Dashboard</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-white shadow-md rounded-xl p-6 border border-gray-200">
                    <h5 className="text-xl font-semibold mb-4 text-gray-800">Patient Management</h5>
                    <p className="text-gray-600 mb-4">View and manage patient records</p>
                </div>
                <div className="bg-white shadow-md rounded-xl p-6 border border-gray-200">
                    <h5 className="text-xl font-semibold mb-4 text-gray-800">Appointments</h5>
